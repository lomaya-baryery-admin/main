...
const Breadcrumbs = () => {
  ...
  return (
    <>
      ...
      <h4 style={{ fontFamily: 'sans-serif', fontWeight: 400 }}><br/><br/><br/>
      Чтобы добавить на страницу цепочку навигации, надо совершить два действия:<br/><br/>
        1. На странице, которая должна быть в цепочке навигации, добавить в history.location.state объект<br/>
        с параметрами для Breadcrumbs. Объект должен обязательно содержать path, url, title.<br/>
