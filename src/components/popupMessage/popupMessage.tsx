...
export const PopupMessage = React.forwardRef<HTMLDivElement, IPopupMessageProps>(
  ({ closePopup }, ref) => {
    ...
    return (
      <Popup title="Добавить сообщение" closePopup={closePopup} ref={ref}>
        <form name="message" onSubmit={sendMessage} className={styles.form}>
          <textarea
            name="text"
            autoComplete="off"
            ref={textareaRef}
          ...
          <div className={styles.buttons}>
            <Button htmlType="button" onClick={closeWithResert} size="small" type="secondary">
              Отменить
            </Button>
